...
//                currentContentVC.removeFromParent()
                ...
                setCurrentView2(selectedContentVC)
            }
        } else {
    ...
    public func selectContentViewController2(_ selectedContentVC: UIViewController) {
        setCurrentView2(selectedContentVC)
    }
}
...
fileprivate extension MenuContainerViewController {
    ...
    func setCurrentView2(_ selectedContentVC: UIViewController) {
//        addChild(selectedContentVC)
//        view.addSubviewWithFullSizeConstraints(view: selectedContentVC.view)
        self.present(selectedContentVC, animated: true, completion: nil)
        currentContentViewController = selectedContentVC
    }
