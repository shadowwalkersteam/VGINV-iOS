...
public let CometChatKingfisherErrorDomain = "com.onevcat.CometChatKingfisher.Error"
...
public let CometChatKingfisherErrorStatusCodeKey = "statusCode"
...
extension Collection where Iterator.Element == CometChatKingfisherOptionsInfoItem {
    ...
    public var onFailureImage: Optional<CFCrossPlatformImage?> {
...
public typealias Image = CFCrossPlatformImage
@available(*, deprecated, message: "Use `CFCrossPlatformView` instead.")
public typealias View = CFCrossPlatformView
@available(*, deprecated, message: "Use `CFCrossPlatformColor` instead.")
public typealias Color = CFCrossPlatformColor
@available(*, deprecated, message: "Use `CFCrossPlatformImageView` instead.")
public typealias ImageView = CFCrossPlatformImageView
@available(*, deprecated, message: "Use `CFCrossPlatformButton` instead.")
public typealias Button = CFCrossPlatformButton
#else
@available(*, deprecated, message: "Use `CFCrossPlatformImage` instead.")
public typealias Image2 = CFCrossPlatformImage
@available(*, deprecated, message: "Use `CFCrossPlatformColor` instead.")
public typealias Color2 = CFCrossPlatformColor
    #if !os(watchOS)
    @available(*, deprecated, message: "Use `CFCrossPlatformImageView` instead.")
    public typealias ImageView = CFCrossPlatformImageView
    @available(*, deprecated, message: "Use `CFCrossPlatformView` instead.")
    public typealias View2 = CFCrossPlatformView
    @available(*, deprecated, message: "Use `CFCrossPlatformButton` instead.")
    public typealias Button2 = CFCrossPlatformButton
    #endif
#endif
