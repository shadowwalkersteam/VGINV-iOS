...
extension ImageProcessor {
    public func process(item: ImageProcessItem, options: CometChatKingfisherOptionsInfo) -> CFCrossPlatformImage? {
...
public struct DefaultImageProcessor: ImageProcessor {
    ...
    ///
    /// - Note: See documentation of `ImageProcessor` protocol for more.
    public func process(item: ImageProcessItem, options: CometChatKingfisherParsedOptionsInfo) -> CFCrossPlatformImage? {
        switch item {
...
public struct BlendImageProcessor: ImageProcessor {
    ...
    public let backgroundColor: CFCrossPlatformColor?
    ...
    public init(blendMode: CGBlendMode, alpha: CGFloat = 1.0, backgroundColor: CFCrossPlatformColor? = nil) {
...
public struct OverlayImageProcessor: ImageProcessor {
    ...
    public let overlay: CFCrossPlatformColor
    ...
    public init(overlay: CFCrossPlatformColor, fraction: CGFloat = 0.5) {
...
public struct DownsamplingImageProcessor2: ImageProcessor {
    ...
    public init(size: CGSize) {
        self.size = size
        self.identifier = "com.onevcat.CometChatKingfisher.DownsamplingImageProcessor2(\(size))"
    }
