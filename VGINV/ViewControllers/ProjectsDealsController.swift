...
class ProjectsDealsController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
...
extension ProjectsDealsController: Configurable {
    func setup() {
...
private extension ProjectsDealsController {
    func reload() {
